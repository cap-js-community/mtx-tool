...
```
npx @cap-js-community/mtx-tool@0.13.0 --svm-fresh-bindings all-services all-tenants
...
npx @cap-js-community/mtx-tool@0.13.0 --svm-repair-bindings all-services
...
npx @cap-js-community/mtx-tool@0.13.0 --cds-upgrade-all
```
