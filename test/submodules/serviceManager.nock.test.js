  ...
  describe("list", () => {
    test("list basic", async () => {
      ...
      expect(outputFromLoggerPartitionFetch(mockLogger.info.mock.calls)).toMatchInlineSnapshot(`
        ...
        GET https://service-manager.cfapps.sap.hana.ondemand.com/v1/service_plans?fieldQuery=service_offering_id%20eq%20'8c3922c9-fcbd-469e-9393-2d941400f2c1'%20and%20name%20eq%20'svm-shared' 200 OK (88ms)"
      `);
