  ...
  describe("list", () => {
    ...
    test("list timestamps", async () => {
      ...
      expect(anonymizeListTimestamps(output)).toMatchInlineSnapshot(`
        ...
        23  d91fb749-a148-479f-b29d-71b1b6a9309d  9e954752-5a2d-45fa-a809-e9707cedf2e5  service-manager-items-21-credentials-host:443  service-manager-items-21-credentials-schema  true    2025-05-22T12:27:03Z (x days ago)  2025-05-22T12:27:14Z (x days ago)  
