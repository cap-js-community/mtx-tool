  ...
  describe("list", () => {
    test("list basic", async () => {
      ...
      expect(outputFromLoggerPartitionFetch(mockLogger.info.mock.calls)).toMatchInlineSnapshot(`
        ...
        req-01 GET https://service-manager.cfapps.sap.hana.ondemand.com/v1/service_offerings?fieldQuery=name%20eq%20'hana' 200 OK (88ms)
        req-02 GET https://service-manager.cfapps.sap.hana.ondemand.com/v1/service_plans?fieldQuery=service_offering_id%20eq%20'8c3922c9-fcbd-469e-9393-2d941400f2c1'%20and%20name%20eq%20'hdi-shared' 200 OK (88ms)
        req-03 GET https://service-manager.cfapps.sap.hana.ondemand.com/v1/service_instances?fieldQuery=service_plan_id%20eq%20'1b702f36-bd66-4fad-b4d8-75cf0a0b8347' 200 OK (88ms)
        req-04 GET https://service-manager.cfapps.sap.hana.ondemand.com/v1/service_bindings?labelQuery=service_plan_id%20eq%20'1b702f36-bd66-4fad-b4d8-75cf0a0b8347' 200 OK (88ms)"
      `);
    ...
    test("list filtered basic", async () => {
      ...
      expect(outputFromLoggerPartitionFetch(mockLogger.info.mock.calls)).toMatchInlineSnapshot(`
        ...
        req-01 GET https://service-manager.cfapps.sap.hana.ondemand.com/v1/service_offerings?fieldQuery=name%20eq%20'hana' 200 OK (88ms)
        req-02 GET https://service-manager.cfapps.sap.hana.ondemand.com/v1/service_plans?fieldQuery=service_offering_id%20eq%20'8c3922c9-fcbd-469e-9393-2d941400f2c1'%20and%20name%20eq%20'hdi-shared' 200 OK (88ms)
        req-03 GET https://service-manager.cfapps.sap.hana.ondemand.com/v1/service_instances?fieldQuery=service_plan_id%20eq%20'1b702f36-bd66-4fad-b4d8-75cf0a0b8347'&labelQuery=tenant_id%20eq%20'5ecc7413-2b7e-414a-9496-ad4a61f6cccf' 200 OK (88ms)
        req-04 GET https://service-manager.cfapps.sap.hana.ondemand.com/v1/service_bindings?labelQuery=service_plan_id%20eq%20'1b702f36-bd66-4fad-b4d8-75cf0a0b8347'%20and%20tenant_id%20eq%20'5ecc7413-2b7e-414a-9496-ad4a61f6cccf' 200 OK (88ms)"
      `);
      expect(mockLogger.error).toHaveBeenCalledTimes(0);
    });
